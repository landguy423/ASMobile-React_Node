...
import setDevice from '../support/action/app/setDevice';
...
module.exports = function given() {
  ...
  this.Given(
    /I am on (a|an) (ios|android) device$/, {timeout: 900 * 1000},
    (article, device, done) => { setDevice(device, done); }
  );

  this.Given(
    /^the element "([^"]*)?" is( not)* visible$/, {timeout: 60 * 1000},
    isVisible
  );
