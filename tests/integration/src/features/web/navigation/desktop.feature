  ...
  Scenario: Navbar Right should be there
    ...
    And I expect the element ".navigation-bar__right > div > div" does exist
    And I expect the first element ".navigation-bar__right > div > div > div" contains the text "SIGN UP"
    And I expect the third element ".navigation-bar__right > div > div > div" contains the text "LOG IN"

  Scenario: There is a Central Display
    Given the element "#topot" is visible
    Then I expect the first element "#topot .custom__button" contains the text "SIGN UP"
    And I expect the second element "#topot .custom__button" contains the text "LOG IN"
  ...
  Scenario: We should scroll down and find sales text
    ...
    And I expect the element "#topot + div div[style*='background: url']" is visible
    And I expect that there are 2 "#topot + div .custom__button" elements

  Scenario: We should see the app sales text
    Given the element "App Section" is visible
    Then I expect the element "App Section" contains any text
    And I expect that there are 3 "App Section img" elements
  ...
  Scenario: We should see the latest community members
    Given the element "Community Section" is visible
    Then I expect the element "Community Section" contains any text

  Scenario: We should see a red connect bar
    Given the element "Connected Section" is visible
    Then I expect the element "Connected Section" contains any text
    And I expect that there are 1 "Connected Section .custom__button" elements
    And I expect the element "Connected Section .custom__button" is visible
    And I expect the element "Connected Section .custom__button" contains any text
   
  Scenario: The footer should be there
    Given the element "#footer" is visible
    Then I expect the element "#footer" contains any text
    And  I expect that there are 4 "#footer img" elements
    And I expect the element "#footer a[href='https://www.facebook.com/']" is enabled
    And I expect the element "#footer a[href='https://www.twitter.com/']" is enabled

  Scenario: I click on About
    Given the element "ons-toolbar > div.left > ons-toolbar-button" is visible
    When I click on the element "ons-toolbar > div.left > ons-toolbar-button"
    Then I expect that element "ons-splitter-side" becomes visible
    Then I expect the second element "div.panel__listItem" is enabled
    Then I expect that element "ons-splitter-side > ons-page" is visible
  ...
  Scenario: I click on Store
    ...
    When I click on the element "ons-toolbar > div.left > ons-toolbar-button"
    Then I expect that element "ons-splitter-side" becomes visible
    And I expect the third element "div.panel__listItem" becomes visible
    Then I expect that element "ons-splitter-side > ons-page" is visible
    Then I expect the browser to pause for 1000 milliseconds  
    When I click on the third element "div.panel__listItem"
    Then I expect that element ".page__content" becomes visible
  
  Scenario: Store Page Is Displayed
    Given the element "ons-splitter-content .page__content > div" is visible
    Then I expect the element "ons-splitter-content .page__content > div" contains any text
    And I expect that the path is "/#Store"

  Scenario: I click on Contact
    Given the element "ons-toolbar > div.left > ons-toolbar-button" is visible
    Then I expect the fourth element "div.panel__listItem" is visible
    When I click on the element "ons-toolbar > div.left > ons-toolbar-button"
    Then I expect that element "ons-splitter-side" becomes visible
    Then I expect that element "ons-splitter-side > ons-page" is visible
    Then I expect the browser to pause for 1000 milliseconds  
