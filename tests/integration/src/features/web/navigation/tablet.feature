  ...
  Scenario: I am on a Tablet
    Given I have a screen that is 900 by 800 pixels
  ...
  Scenario: There is a Central Display
    ...
    Then I expect the element "#topot" has the class "homeTablet__header"
    And I expect the first element "#topot .custom__button" contains the text "SIGN UP"
  ...
  Scenario: Store Page Is Displayed
    ...
    Then I expect the element ".page__content > div" contains any text
