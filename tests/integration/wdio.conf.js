exports.config = {
  ...
  suites: {
    registration: ['./src/features/web/registration/*.feature', './src/features/web/registration/facebook/*.feature'],
    navigation: ['./src/features/web/navigation/*.feature'],
    contact: ['./src/features/web/contact/*.feature'],
    login: ['./src/features/web/login/*.feature', './src/features/web/login/forgot/*.feature']
  },
  // Patterns to exclude.
  exclude: [
    './src/features/android/*.feature', './src/features/ios/*.feature'
  ],
  //
  // ============
  // Capabilities
