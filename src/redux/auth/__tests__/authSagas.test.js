...
describe('resetPasswordFlow', () => {
  ...
  it('success flow', () => {
    const generator = sagas.resetPasswordFlow(action);

    expect(generator.next().value)
      .toEqual(call(sagas.retryAuth, callApi, params));

    expect(generator.next().value)
      .toEqual(put(actions.resetPassword.success()));
  });
  ...
  it('failure flow', () => {
    ...
    expect(generator.throw(error).value)
      .toEqual(put(actions.resetPassword.failure(error)));
  });
});
...
describe('forgotPasswordFlow', () => {
  ...
  it('success flow', () => {
    const generator = sagas.forgotPasswordFlow(action);

    expect(generator.next().value)
      .toEqual(call(sagas.retryAuth, callApi, params));

    expect(generator.next().value)
      .toEqual(put(actions.forgotPassword.success()));
  });
  ...
  it('failure flow', () => {
    ...
    expect(generator.throw(error).value)
      .toEqual(put(actions.forgotPassword.failure(error)));
  });
});
