...
// ------------------------------------
// TEST FORGOT_PASSWORD_REQUESTED
// ------------------------------------
it('handles FORGOT_PASSWORD_REQUESTED', () => {
  expect(reducer(initialState, {
    type: constants.FORGOT_PASSWORD_REQUESTED
  })).toEqual({
    ...initialState,
    resetPasswordEmailIsSend: false,
    errors: { ...initialState.errors, forgotPassword: false }
  });
});

// ------------------------------------
// TEST FORGOT_PASSWORD_SUCCESS
// ------------------------------------
...
// ------------------------------------
// TEST FORGOT_PASSWORD_FAILED
// ------------------------------------
it('handles FORGOT_PASSWORD_FAILED', () => {
  const error = 'test';
  ...
  expect(reducer(initialState, {
    ...
    ...initialState,
    errors: { ...initialState.errors, forgotPassword: error }
  });
});

// ------------------------------------
// TEST RESET_PASSWORD_REQUESTED
// ------------------------------------
it('handles RESET_PASSWORD_REQUESTED', () => {
  expect(reducer(initialState, {
    type: constants.RESET_PASSWORD_REQUESTED
  })).toEqual({
    ...initialState,
    passwordIsReset: false,
    errors: { ...initialState.errors, resetPassword: false }
  });
});
...
// ------------------------------------
it('handles RESET_PASSWORD_SUCCESS', () => {
  expect(reducer(initialState, {
...
// ------------------------------------
// TEST RESET_PASSWORD_FAILED
// ------------------------------------
it('handles RESET_PASSWORD_FAILED', () => {
  const error = 'test';
  ...
  expect(reducer(initialState, {
    ...
    ...initialState,
    errors: { ...initialState.errors, resetPassword: error }
  });
});
